...
void plot_all_hists(string pathname)
{
  ...
  std::vector<std::string> rootFiles;
   ...
   FileFolder = "LYSO_out_root_files";
  ...
  //folder = {"Rep_plots/BGO/PhoInteract"};
  //folder = {"plots"};
  ...
  for(int iFile=0; iFile < f.size(); iFile++){ //looping over each file    		    
	...
	if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/BGO/2.5cm"; Width = "2.5cm";} 
	if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/BGO/5cm"; Width = "5cm";}
	if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/BGO/10cm"; Width = "10cm";}
	}		

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 8500; logFlag = false;
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/BGO/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/BGO/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/BGO/10cm"; Width = "10cm";}	  
	}
	...
	if (!(histId.Contains("nOptical_Photons"))){
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/PbWO4/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/PbWO4/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/PbWO4/10cm"; Width = "10cm";}
	}	

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 250; logFlag = false;
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/PbWO4/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/PbWO4/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/PbWO4/10cm"; Width = "10cm";}	  
	}
	...
	filetag = "PbWO4_" + Energy + "_" + Width;
      ...
      if(FileId.Contains("GAGG")){
        if (!(histId.Contains("nOptical_Photons"))){
	  if (FileId.Contains("1cm")) {folder = "Rep_plots/" + MainFolder + "/GAGG/1cm"; Width = "1cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/GAGG/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/GAGG/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/GAGG/10cm"; Width = "10cm";}
	}	

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 30000; logFlag = false;
	  if (FileId.Contains("1cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/GAGG/1cm"; Width = "1cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/GAGG/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/GAGG/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/GAGG/10cm"; Width = "10cm";}	  
	}
	...
	if (!(histId.Contains("nOptical_Photons"))){
	  if (FileId.Contains("1cm")) {folder = "Rep_plots/" + MainFolder + "/LaBr3/1cm"; Width = "1cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/LaBr3/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/LaBr3/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/LaBr3/10cm"; Width = "10cm";}
	}

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 62000; logFlag = false;
	  if (FileId.Contains("1cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LaBr3/1cm"; Width = "1cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LaBr3/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LaBr3/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LaBr3/10cm"; Width = "10cm";}	  
	}
	...
	if (!(histId.Contains("nOptical_Photons"))){
	  if (FileId.Contains("1cm")) {folder = "Rep_plots/" + MainFolder + "/Plastic/1cm"; Width = "1cm";}
	  if (FileId.Contains("20cm")) {folder = "Rep_plots/" + MainFolder + "/Plastic/20cm"; Width = "20cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/Plastic/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/Plastic/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/Plastic/10cm"; Width = "10cm";}
	}

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 12000; logFlag = true; rebin[0] = 5;
	  if (FileId.Contains("20cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/Plastic/20cm"; Width = "20cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/Plastic/5cm"; Width = "5cm";}
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/Plastic/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_1cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/Plastic/1cm"; Width = "1cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/Plastic/10cm"; Width = "10cm";}	  
	}	
	
	filetag = "Plastic_" + Energy + "_" + Width;
      }

      if(FileId.Contains("LYSO")){
	if (!(histId.Contains("nOptical_Photons"))){
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/LYSO/2.5cm"; Width = "2.5cm";} 
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/LYSO/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/LYSO/10cm"; Width = "10cm";}
	}		

	else if (histId.Contains("nOptical_Photons")) {
	  xmax[0] = 32000; logFlag = false;
	  if (FileId.Contains("2.5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LYSO/2.5cm"; Width = "2.5cm";}
	  if (FileId.Contains("_5cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LYSO/5cm"; Width = "5cm";}
	  if (FileId.Contains("10cm")) {folder = "Rep_plots/" + MainFolder + "/nOpticalPhotons/LYSO/10cm"; Width = "10cm";}	  
	}
	
	filetag = "LYSO_" + Energy + "_" + Width;	
      }

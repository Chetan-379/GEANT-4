void plot_txt() {
    // Open input file
    std::ifstream infile("plots/Scintillation/Fits/txtFiles/PbWO4/Efficiency_vs_Einc_PbWO4_5cm.txt");
    if (!infile.is_open()) {
    ...
    graph->SetTitle("PbWO4_5cm"); // Set axis titles via SetTitle
    ...
    graph->SetMinimum(0.8);                 // bgo resolution
    ...
    // canvas->SaveAs((fileName.erase(pos, 4) + ".png").c_str());

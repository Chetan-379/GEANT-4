...
void data_plot() {
  ...
  TSystemDirectory dir("test_plots/Scintillation/Fits/txtFiles", "test_plots/Scintillation/Fits/txtFiles");
  ...
  while ((obj = next())) {
    ...
    if (fname.EndsWith(".txt")) {
      data_files.push_back("test_plots/Scintillation/Fits/txtFiles/" + string(fname.Data()));
    }
  }
  ...
  for (int i=0; i<data_files.size(); i++){
    ...
    MainFolder = "test_plots/Scintillation/Fits/Resol_Resp";
...
void Working_FitFunc(string pathname)
{
  ...
  //TString FileFolder = "GAGG_out_root_files";
  ...
  string MainFolder = "test_plots/Scintillation/Fits/ItrFit";;

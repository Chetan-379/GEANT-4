...
TString legend_text[15] = {"PbWO4","BGO", "LYSO", "GAGG", "LaBr3"};
...
void overlay(string pathname)
{
  ...
  f= {"PbWO4_out_root_files/PbWO4_10cm_ScintON_1000keV_Birk0_NoAbs_NoCeren_DerEmis_spline_out.root", "BGO_out_root_files/BGO_10cm_ScintON_1000keV_Birk0_NoAbs_NoCeren_SefDerEmiss_spline_out.root", "LYSO_out_root_files/LYSO_10cm_ScintON_1000keV_Birk0_NoAbs_NoCeren_spline_out.root", "GAGG_out_root_files/GAGG_10cm_ScintON_1000keV_Birk0_NoAbs_NoCeren_DerEmis_spline_out.root", "LaBr3_out_root_files/LaBr3_10cm_ScintON_1000keV_Birk0_NoAbs_NoCeren_DerEmis_spline_out.root"};

...
TString legend_text[15] = {"PbWO4","BGO", "LYSO", "GAGG", "LaBr_{3}"};
...
void overlay(string)
{
  ...
  for (int iEn =0; iEn<Energies.size(); iEn++){
    for (int iDepth =0; iDepth<Depths.size(); iDepth++){
      ...
      vector<string> f;
      string rootFile1 = "PbWO4_out_root_files/PbWO4_"+Depths[iDepth]+"_ScintON_"+ Energies[iEn] +"_Birk0_NoAbs_spline_out.root";
      string rootFile2 = "BGO_out_root_files/BGO_"+Depths[iDepth]+"_ScintON_"+ Energies[iEn] +"_Birk0_NoAbs_spline_out.root";
      string rootFile3 = "LYSO_out_root_files/LYSO_"+Depths[iDepth]+"_ScintON_"+ Energies[iEn] +"_Birk0_NoAbs_spline_out.root";
      string rootFile4 = "GAGG_out_root_files/GAGG_"+Depths[iDepth]+"_ScintON_"+ Energies[iEn] +"_Birk0_NoAbs_spline_out.root";
      string rootFile5 = "LaBr3_out_root_files/LaBr3_"+Depths[iDepth]+"_ScintON_"+ Energies[iEn] +"_Birk0_NoAbs_spline_out.root";
      

      cout << "\nrootFileName1: " << rootFile1 << "\n\n";
      f= {rootFile1, rootFile2, rootFile3, rootFile4, rootFile5};
      ...
      //x axis range
      vector<double>xmax = {0.2, 0.25, 0.4, 0.5, 0.6, 0.7, 0.9, 1.1};
	...
	string fileTag = "E_{#gamma} " + Energies[iEn] + ", " + "Depth " + Depth;
	...
	sprintf(full_path,"%s/%s_%s_%d%d_%s_%s",folder[iVar].c_str(), "Material_Overlay", diff_title[iVar].c_str(), iDepth, iEn, Energy.c_str(), Depth.c_str());

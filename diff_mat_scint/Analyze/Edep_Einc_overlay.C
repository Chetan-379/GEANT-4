...
void Edep_Einc_overlay()
{
  ...
  for (int iMat =0; iMat<Materials.size(); iMat++){
	...
	cout << full_path << endl;	 	      
	generate_1Dplot(hist_list,full_path,xmax_PbWO4[iDepth],xmin[iDepth],leg_head,false,true,false,true,filetag[iVar].c_str(),xtitle[iVar].c_str(),rebin_PbWO4[iVar]);

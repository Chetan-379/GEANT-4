...
TString legend_text[15] = {"100keV","300keV", "511keV", "1000keV"};
...
void overlay(string)
{
  ...
  for (int iMat =0; iMat<Materials.size(); iMat++){
    ...
    for (int iDepth =0; iDepth<Depths.size(); iDepth++){
      ...
      string rootFile2 = Materials[iMat]+"_out_root_files/"+Materials[iMat]+"_"+Depths[iDepth]+"_ScintON_"+ "300keV" +"_Birk0_NoAbs_spline_out.root";
      string rootFile3 = Materials[iMat]+"_out_root_files/"+Materials[iMat]+"_"+Depths[iDepth]+"_ScintON_"+ "511keV" +"_Birk0_NoAbs_spline_out.root";
      string rootFile4 = Materials[iMat]+"_out_root_files/"+Materials[iMat]+"_"+Depths[iDepth]+"_ScintON_"+ "1000keV" +"_Birk0_NoAbs_spline_out.root";
      ...
      vector<double>xmax = {1.1, 1.1, 1.1, 1.1};
	...
	diff_title = { "Total_Edep", "Compt_Edep", "Photo_Edep"};
	vector<string>xtitle;
	xtitle = {"Total_Edep(MeV)", "Compt_Edep(MeV)", "Photo_Edep(MeV)"};
	...
	cout << full_path << endl;	 	      
	generate_1Dplot(hist_list,full_path,xmax[iDepth],xmin[iDepth],leg_head,false,true,false,true,filetag[iVar].c_str(),xtitle[iVar].c_str(),rebin[iVar]);

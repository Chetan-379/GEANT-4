...
void FitOverlay(vector<TF1*> funcs, vector<TGraphErrors*> graphs) {
  ...
  c2->SaveAs("BGO_resolution_points_overlay.png");
}
...
void FitFunc(string pathname)
{
  ...
  TxtArr = {"BGO_2.5cm", "BGO_5cm", "BGO_10cm", "PbWO4_2.5cm", "PbWO4_5cm", "PbWO4_10cm", "Plastic_5cm", "Plastic_10cm", "Plastic_20cm", "GAGG_1cm", "GAGG_2.5cm", "GAGG_5cm", "GAGG_10cm", "LaBr3_1cm", "LaBr3_2.5cm", "LaBr3_5cm", "LaBr3_10cm"};

...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
  ...
  std::vector<G4double> refractiveIndex1 = {2.24, 2.29, 2.30, 2.30, 2.31, 2.32};

  
  std::vector<G4double> absorption = {3.448 * m,  4.082 * m,  6.329 * m,  9.174 * m,  12.346 * m, 13.889 * m};
  ...
  std::vector<G4double> scintilSlow = {0.01, 1.00, 2.00, 3.00, 4.00, 5.00};
